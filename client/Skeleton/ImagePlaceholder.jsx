  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        <div className="bg-gray-200 dark:bg-gray-700 mb-2.5 h-2 max-w-[480px] rounded-full"></div>
        <div className="bg-gray-200 dark:bg-gray-700 mb-2.5 h-2 rounded-full"></div>
        <div className="bg-gray-200 dark:bg-gray-700 mb-2.5 h-2 max-w-[440px] rounded-full"></div>
        <div className="bg-gray-200 dark:bg-gray-700 mb-2.5 h-2 max-w-[460px] rounded-full"></div>
