...
export declare class OrganizationsController {
    ...
    create(req: Request, createOrganizationDto: CreateOrganizationDto): Promise<{
        projects: {
            id: string;
    ...
    updateById(id: any, updateOrgDto: UpdateOrganizationDto): Promise<{
        projects: {
            id: string;
            organizationId: string;
            title: string;
